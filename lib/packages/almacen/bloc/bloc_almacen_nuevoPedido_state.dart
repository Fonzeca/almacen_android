...
class NuevoPedidoState extends Equatable{
  ...
  final String nombresArticulosFromQr;
  ...
  NuevoPedidoState copyWith({String nombreUsuario, List<Artxcant> articulosAPedir, String observaciones, List<String> listaUsuarios, List<Articulo> listaArticulos, String nombresArticulosFromQr}){
    return NuevoPedidoState(
        ...
        nombresArticulosFromQr ?? nombresArticulosFromQr
    );
  }
}
